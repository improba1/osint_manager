...
async def _check_single_site(url, service_name, semaphore, error_marker): 
   headers = {
...
async def check_all_sites(username):
   ...
   for service_name, service_data in SERVICES.items():
      ...
      task = asyncio.create_task(_check_single_site(ready_url, service_name, semaphore, marker))
      tasks.append(task)
